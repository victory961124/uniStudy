	...
	<view class="p-2">
		...
		<view class="flex align-center justify-between">
			<view class="flex align-center">
				<!--头像-->
				<image :src="item.userpic" class="mr-2 rounded-circle" style="width: 65rpx;height: 65rpx;"></image>
		...
		<!-- 图片 尽可能给具体的高度-->
		<image :src="item.titlepic" class="rounded w-100" style="height: 350rpx;"></image>
		<!-- 图标按钮 -->
		<view class="flex align-center">
